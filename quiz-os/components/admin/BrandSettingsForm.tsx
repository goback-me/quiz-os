...
export default function BrandSettingsForm({
  ...
  clientId: string
  initialTheme: { primary: string; secondary: string; font?: string; logoUrl?: string; pageBackground?: string }
      ...
      <form action={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <div className="w-full max-w-[280px] bg-white rounded-xl shadow-md p-4 mt-4">
              ...
              <h3 className="text-center font-semibold mb-3" style={{ color: primary }}>
                Which product fits your needs?
              </h3>
              <div className="flex flex-col gap-2 mt-3">
                <button className="w-full py-2 px-3 rounded-lg border border-gray-200 text-sm text-left" type="button">
                  Enterprise Suite
                </button>
                <button className="w-full py-2 px-3 rounded-lg border border-gray-200 text-sm text-left" type="button">
                  Starter Pack
